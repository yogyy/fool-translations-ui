...
<main class="mt-14 min-h-dvh overflow-hidden">
  <div
    ...
    <nav class="container mx-auto flex justify-center space-x-2 overflow-x-auto whitespace-nowrap">
      <div
        class="no-scrollbar relative h-10 w-auto snap-x snap-mandatory items-center justify-center overflow-x-hidden scroll-smooth whitespace-nowrap rounded-none bg-transparent px-1 pb-0">
